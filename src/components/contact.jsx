    ...
    <div className="contactSocials">
      ...
      <section className="SocialMediasHolder">
        ...
        <ul className="social_links">
          <li className="s_link">
            <a href="https://www.linkedin.com/in/gisa-chris/" target="blank" rel='noreferrer'>LinkedIn</a>
          </li>
          <li className="s_link">
            <a href="https://wa.me/250784563836" target="blank" rel='noreferrer'>WhatsApp</a>
          </li>
          <li className="s_link">
            <a href="https://twitter.com/_GisaChris" target="blank" rel='noreferrer'>Twitter</a>
          </li>
          <li className="s_link">
            <a href="https://github.com/gisachris" target="blank" rel='noreferrer'>GitHub</a>
          </li>
        </ul>
      </section>
    </div>
